...
if [ "$arch" == "x86_64" ]; then
    ...
    # AMD64系统
    IMG=aliyunregistry-gz-mobi-registry.cn-guangzhou.cr.aliyuncs.com/dm/mobili-app-amd64:presubmit-20241014-c2ca7

elif [ "$arch" == "aarch64" ] || [ "$arch" == "arm64" ]; then
    echo "The system is based on ARM64 architecture."
    # ARM64系统
    IMG=aliyunregistry-gz-mobi-registry.cn-guangzhou.cr.aliyuncs.com/dm/mobili-app:presubmit-20241014-c2ca7
